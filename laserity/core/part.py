...
class PartGeometry:
  ...
  def __init__(self, name="", thickness=0.0, contours=None, engrave_regions=None,
               engrave_lines=None, method=METHOD_AUTO):
    self.name = name
...
class PlacedPart:
  ...
  __slots__ = ("name", "geometry", "thickness", "thickness_key", "sheet", "rotation",
               "offset", "mirrored")

  def __init__(self, name, geometry, thickness, thickness_key, sheet=0,
               rotation=0.0, offset=(0.0, 0.0), mirrored=False):
    self.name = name
